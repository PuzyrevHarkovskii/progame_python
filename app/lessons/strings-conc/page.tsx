        ...
        <Box p={5}>
          <ChakraProvider theme={MainTheme}>
            ...
            <Text>
              ...
              программировании, но и в жизни. Алгоритм — это последовательность
              шагов или операция для решения какой-либо задачи.
            </Text>
            <Text>
            ...
            <UnorderedList>
              ...
              <ListItem>Переменной a присвоить значение переменной b.</ListItem>
              <ListItem>
                Переменной b присвоить значение дополнительной переменной tmp.
                Это значение равно старому значению переменной a.
              </ListItem>
              <ListItem>
                Убедиться, правильно ли вы все сделали. Для этого можно вывести
                значения переменных на экран. Хотя это и необязательно для
                прохождения задачи.
              </ListItem>
            </UnorderedList>
            <Text>
              В последующих задачах обязательно пробуйте разрабатывать алгоритм
              самостоятельно. Например, можете записывать шаги на листке бумаги.
              Это помогает раздробить крупную или сложную задачу на более мелкие
              и простые части.
            </Text>
...
b = a`}
            ...
            <Text>
              ...
              выполнении первой строки, значение a будет затерто значением b. То
              есть, после выполнения такого кода и в a и b будет храниться одно
              и тоже значение.
            </Text>
            <PythonCompiler />
            </PythonProvider>
...
print(c)`}
            ...
            <CodeFragment
              ...
              showLineNumbers={false}
            ></CodeFragment>         
                <Text>То есть оператор + может не только складывать числа, но и склеивать строки.</Text>
          ...
          <Box
            ...
            >
             ...
             <ListItem>Переменной hello присвойте значение «Привет,» или «Здравствуй,»</ListItem>
             <ListItem>Переменной name присвойте значение, полученное с помощью функции input от пользователя.</ListItem>
             <ListItem>Переменной greeting присвойте значение, равное склеенным строкам hello и name.</ListItem>
